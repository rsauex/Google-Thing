...
(defun @add-request (video-id endpoint-id requests-num)
  (setf (gethash video-id (net-videos-ht *net*)) (make-video :size (video-size (gethash video-id (net-videos-ht *net*)))
                                                             ...
                                                             :total-requests (+ (video-total-requests (gethash video-id (net-videos-ht *net*))) requests-num)))
  (setf (gethash endpoint-id (net-endpoints-ht *net*)) (make-endpoint :connections (endpoint-connections (gethash endpoint-id (net-endpoints-ht *net*)))
                                                                      :vid-req (cons video-id requests-num))))
